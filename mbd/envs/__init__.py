...
def get_env(
    ...
    enable_collision_projection=False,
    hitch_penalty=0.10,
    enable_hitch_projection=True,
    ...
    if env_name == "car2d":
        ...
        return TractorTrailer2d(
            ...
            enable_collision_projection=enable_collision_projection,
            hitch_penalty=hitch_penalty,
            enable_hitch_projection=enable_hitch_projection,

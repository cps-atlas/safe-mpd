"""
Test Module for MBD (Model-Based Diffusion) Planner
=========================
...
Setup
-----
Tests require the MBD environment to be properly installed and configured.

Examples
--------
To run all MBD planner tests (from the root of the repository):
